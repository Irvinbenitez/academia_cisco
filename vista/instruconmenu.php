...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody><tr height="60" align="center" bgcolor="#d9d9d9">
			...
			<td colspan="4"><h1 class="instru">Instructor</h1></td>-->
...
<!--<a href="ctrlinstrucon.php?accion=add">Ingresar Nuevo</a>-->
<?php

?>
<a href="ctrlinstrucon.php?accion=list">Listar Estudiantes</a>
