...
class instructor
{
	...
	public function insertar($id,$nom,$ape,$modu,$cert,$secc,$hor,$ciclo,$conexion)
	{
		$res=mysqli_query($conexion, "call sp_insertinstru('".$id."','".$nom."','".$ape."','".$modu."','".$cert."','".$secc."','".$hor."','".$ciclo."');");
		$sentencia="call sp_insertinstru('".$id."','".$nom."','".$ape."','".$modu."','".$cert."','".$secc."','".$hor."','".$ciclo."')";
		if($res)
		{
	...
	public function modificar($id,$nom,$ape,$modu,$cert,$secc,$hor,$ciclo,$conexion)
	{
		$resMod=mysqli_query($conexion, "call sp_instructorMod('".$id."','".$nom."','".$ape."','".$modu."','".$cert."','".$secc."','".$hor."','".$ciclo."');");
		if($resMod)
		{
